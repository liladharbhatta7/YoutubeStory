...
PART 2 — EMOTIONAL BUILD (middle narration):
  - Use the context/micro-story provided. Preserve [pause], [heavy_sigh], [whisper] tags exactly.
...
- GOOD: "ती २ घण्टा कहाँ हरायौ?" (correct)
- BAD: "यो दृश्यमा बा घाइते छन्।" (wrong — descriptive, not emotional)
...
- ALL fields MUST be written in Devanagari Nepali ONLY:
